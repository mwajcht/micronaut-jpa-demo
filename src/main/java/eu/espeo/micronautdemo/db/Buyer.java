...
public class Buyer {
	...
	public eu.espeo.micronautdemo.domain.Buyer toBuyer() {
		return eu.espeo.micronautdemo.domain.Buyer.builder()
	...
	public static Buyer fromBuyer(eu.espeo.micronautdemo.domain.Buyer buyer) {
